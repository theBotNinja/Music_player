...
file_frame=tk.Frame(frame1,borderwidth=10,relief="ridge",bg="black")  #flat, groove, raised, ridge, solid, or sunken
...
mid_frame=tk.Frame(frame1,width=680,height=600,bg="black")
tk.Label(mid_frame,font="Rockwell",bg="black").pack()
m=tk.Label(mid_frame,text="",font="Rockwell 22",fg="white",bg="black")
m.pack()
tk.Label(mid_frame,font="Rockwell",bg="black").pack()
time=tk.Label(mid_frame,text= "",font="Rockwell 18",fg="black",bg="black")
time.pack()
alb=tk.Label(mid_frame,text= "",font="Rockwell 18",fg="black",bg="black")
alb.pack()
art=tk.Label(mid_frame,text= "",font="Rockwell 18",fg="black",bg="black")
art.pack()
bit=tk.Label(mid_frame,text= "",font="Rockwell 18",fg="black",bg="black")
bit.pack()
tk.Label(mid_frame,font="Rockwell",bg="black").pack()
...
lisx=tk.Listbox(playlist_f,yscrollcommand=scroll.set,width=100,fg="white",bg="black")
...
listbox=tk.Listbox(frame2,yscrollcommand=scrollbar.set,width=100,fg="white",bg="black")
